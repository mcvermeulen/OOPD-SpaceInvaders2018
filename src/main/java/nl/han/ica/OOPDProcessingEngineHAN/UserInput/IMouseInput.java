...
public interface IMouseInput {
	 ...
	 * @param x The x valueIfHit is the relative mouse position calculated with the position of the world (TileMap).
	 * @param y The y valueIfHit is the relative mouse position calculated with the position of the world (TileMap).
	 */
